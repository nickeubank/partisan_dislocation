...
def random_points_in_polygon(
    ...
    :param uniform_swing_to_dems: (default=0)
              ...
              Implemented by increasing binomial probability of drawing
              a dem point by swing, decreasing probability of repub point
              by swing. So a value of 0.05 would move a 45% dem 55%
